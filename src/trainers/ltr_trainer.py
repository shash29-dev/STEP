...
from src.utils.tensorboard import TensorboardWriter
import torch
...
class LTRTrainer(BaseTrainer):
    def __init__(self, actor, loaders, optimizer, settings, lr_scheduler=None, freeze_backbone_bn_layers=False,reload_data=None):
        """
        args:
        ...
        """
        super().__init__(actor, loaders, optimizer, settings, lr_scheduler,reload_data=reload_data)
        ...
        tensorboard_writer_dir = self.settings.env.tensorboard_dir
